...
<div>
  ...
  <section class="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <div class="bg-surface p-6 rounded-xl shadow-lg">
        ...
        <a href="showcase" class="text-blue-400 hover:underline mt-4 block">Ver projeto</a>
    </div>
    <div class="bg-surface p-6 rounded-xl shadow-lg">
      ...
      <a href="kc-overlay" class="text-blue-400 hover:underline mt-4 block">Ver projeto</a>
    </div>
    <div class="bg-surface p-6 rounded-xl shadow-lg">
      ...
      <a href="minelander" class="text-blue-400 hover:underline mt-4 block">Ver projeto</a>
    </div>
  </section>

  <footer class="text-center py-10 mt-10 text-gray-500">
    <a href ="https://github.com/jafkc2" target="_black">
      Meu Github
    </a>
